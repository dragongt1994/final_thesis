 ...
 */
package com.example.arlenerochoa.ftpprac.net.ftp;
...
import com.example.arlenerochoa.ftpprac.net.MalformedServerReplyException;
import com.example.arlenerochoa.ftpprac.net.SocketClient;

import com.example.arlenerochoa.ftpprac.net.ftp.parser.DefaultFTPFileEntryParserFactory;
import com.example.arlenerochoa.ftpprac.net.ftp.parser.FTPFileEntryParserFactory;
import com.example.arlenerochoa.ftpprac.net.ftp.parser.MLSxEntryParser;
import com.example.arlenerochoa.ftpprac.net.io.CRLFLineReader;
import com.example.arlenerochoa.ftpprac.net.io.CopyStreamAdapter;
import com.example.arlenerochoa.ftpprac.net.io.CopyStreamEvent;
import com.example.arlenerochoa.ftpprac.net.io.CopyStreamListener;
import com.example.arlenerochoa.ftpprac.net.io.FromNetASCIIInputStream;
import com.example.arlenerochoa.ftpprac.net.io.ToNetASCIIOutputStream;
import com.example.arlenerochoa.ftpprac.net.io.Util;
 ...
 * {@link com.example.arlenerochoa.ftpprac.net.ftp.FTP#getReplyCode  getReplyCode } after
 ...
 * {@link com.example.arlenerochoa.ftpprac.net.ftp.FTPReply#SERVICE_NOT_AVAILABLE FTPReply.SERVICE_NOT_AVAILABLE }
 ...
 * {@link com.example.arlenerochoa.ftpprac.net.ftp.FTP#getReplyCode  getReplyCode },
 * {@link com.example.arlenerochoa.ftpprac.net.ftp.FTP#getReplyString  getReplyString },
 * and
 * {@link com.example.arlenerochoa.ftpprac.net.ftp.FTP#getReplyStrings  getReplyStrings}.
 ...
 * from com.example.arlenerochoa.ftpprac.net.FTPFileEntryParser:
 * <pre>
 *    FTPClient f = new FTPClient();
 *    f.connect(server);
 *    f.login(username, password);
...
implements Configurable
{
     ...
     * @since 3.0
     */
    public static final String FTP_SYSTEM_TYPE = "com.example.arlenerochoa.ftpprac.net.ftp.systemType";
     ...
     * @since 3.1
     */
    public static final String FTP_SYSTEM_TYPE_DEFAULT = "com.example.arlenerochoa.ftpprac.net.ftp.systemType.default";
     ...
     * <pre>
     * Plan 9=Unix
     * OS410=com.example.arlenerochoa.ftpprac.net.ftp.parser.OS400FTPEntryParser
     * </pre>
     *
     * @since 3.0
     */
    ...
    private void __initDefaults()
    {
        ...
        __activeMinPort = 0;
        __activeMaxPort = 0;
        __fileType           = ASCII_FILE_TYPE;
        __fileStructure      = FILE_STRUCTURE;
        __fileFormat         = NON_PRINT_TEXT_FORMAT;
        __fileTransferMode   = STREAM_TRANSFER_MODE;
        __restartOffset      = 0;
        __systemName         = null;
        __entryParser        = null;
        __entryParserKey    = "";
    ...
    throws IOException
    {
        ...
        return new com.example.arlenerochoa.ftpprac.net.io.SocketOutputStream(socket, output);
    }
     ...
     *
     * @see com.example.arlenerochoa.ftpprac.net.ftp.parser.FTPFileEntryParserFactory
     * @see com.example.arlenerochoa.ftpprac.net.ftp.parser.DefaultFTPFileEntryParserFactory
     */
     ...
     *      to send FTP reply code 421.  This exception may be caught either
     *      as an IOException or independently as itself.
     * @throws com.example.arlenerochoa.ftpprac.net.io.CopyStreamException
    ...
    throws IOException
    {
        ...
        return new com.example.arlenerochoa.ftpprac.net.io.SocketInputStream(socket, input);
    }
     ...
     *                   from the server.
     * @throws com.example.arlenerochoa.ftpprac.net.ftp.parser.ParserInitializationException
     ...
     *                   com.example.arlenerochoa.ftpprac.net.ftp.FTPFileEntryParser
